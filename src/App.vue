      ...
      <div class="bg-gray-800-spotify flex-1 flex flex-col">
        <div class="top-bar flex items-center justify-between px-4 py-2">
          ...
          <div class="flex items-center">
            ...
            <a href="#" class="ml-2 hover:underline hover:text-white">
              muhsenmaqsudi
            </a>
            <button class="ml-4">
              <svg
        ...
        <div class="content-spotify overflow-y-auto">
          <div class="container mx-auto">
            ...
            <div class="mt-12">
              <h3 class="font-semibold text-xl border-b border-gray-900 pb-2">
                Recently Played
              </h3>
              <div class="flex items-center mt-4 -mx-4">
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="@/assets/albums/albumcover02.jpg"
                        alt="album cover"
                    /></a>
                  </div>
                  <div>
                    <a
                      ...
                      >Acoustic Pop Covers 2019</a
                    >
                    <div class="text-gray-500 mt-2">
                      Amazing Acoustic Covers updated every week.
                    </div>
                    <div
                      class="uppercase tracking-widest text-xs text-gray-500 mt-2"
                    >
                      6679 Followers
                    </div>
                  </div>
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="@/assets/albums/albumcover03.jpg"
                        alt="album cover"
                    /></a>
                  </div>
                  <div>
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="@/assets/albums/albumcover04.jpg"
                        alt="album cover"
                    /></a>
                  </div>
                  <div>
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="@/assets/albums/albumcover05.jpg"
                        alt="album cover"
                    /></a>
                  </div>
                  <div>
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a href="#"
                      ><img
                        src="@/assets/albums/albumcover06.jpg"
                        alt="album cover"
                    /></a>
                  </div>
                  <div>
